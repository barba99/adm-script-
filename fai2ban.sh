...
while read linea; do
[[ $linea = "" ]] && break
echo -e "\033[1;37m IP: $(echo $linea|awk '{print $1}') \033[1;31mBLOQUEADA] \033[1;31m->\033[1;33m$(geoiplookup $(echo $linea|awk '{print $1}')|awk '{$1=""}{$2=""}{$3="";print}' )"
done < $fail2ban_list
else
echo -e "\033[1;31m no fue encontrados IPs BLOQUEADAS!"
fi
rm $fail2ban_list
echo -e "$barra"
#UNBAN LISTA
...
while read linea; do
[[ $linea = "" ]] && break
echo -e "\033[1;37m IP: $(echo $linea|awk '{print $1}') \033[1;32mLIBERADA] \033[1;31m->\033[1;33m$(geoiplookup $(echo $linea|awk '{print $1}')|awk '{$1=""}{$2=""}{$3="";print}' )"
done < $fail2ban_list
else
echo -e "\033[1;31m No fue encontrados IPs LIBERADA!"
fi 
rm $fail2ban_list
echo -e "$barra"
#FoundLista
echo -e "\033[1;37m Você deseja ver a lista de IPs detectados?"
...
while read linea; do
[[ $linea = "" ]] && break
echo -e "\033[1;37m IP: $(echo $linea|awk '{print $1}') \033[1;36mDETECTADA] \033[1;31m->\033[1;33m$(geoiplookup $(echo $linea|awk '{print $1}')|awk '{$1=""}{$2=""}{$3="";print}' )"
done < $fail2ban_list
rm $fail2ban_list
echo -e "$barra"
}
...
fail2ban_function () {
echo -e " \033[1;36m FAIL2BAN PROTECCION \033[1;32m[VPS-BARBA]"
echo -e "$barra"
if [[ -e /etc/fail2ban/jail.conf ]]; then
while true; do
echo -e "${cor[2]}[${cor[3]}00${cor[2]}] \033[0;33m>${cor[4]} Ver registro de IPs"
echo -e "${cor[2]}[${cor[3]}00${cor[2]}] \033[0;33m>${cor[4]} Remover fail2ban"
echo -e "${cor[2]}[${cor[3]}00${cor[2]}] \033[0;33m>${cor[4]} REGRESAR\n${barra}"
while [[ ${lo_og} != [0-2] ]]; do
echo -ne "\033[1;37m Seleccione una Opcion: " && read lo_og
tput cuu1 && tput dl1
done
case $lo_og in
     0)
...
echo -e "$barra"
if [ "$failtwoban" != "" ]; then
echo -e "\033[1;31m FAIL2BAN no se instalo!"
echo -e "$barra"
else
echo -e "\033[1;32m FAIL2BAN instalado!"
echo -e "$barra"
fi
return
}
